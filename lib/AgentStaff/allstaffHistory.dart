...
class AllStaffHistoryPage extends StatefulWidget {
  final String mobile;
  const AllStaffHistoryPage({super.key, required this.mobile});

  @override
  State<AllStaffHistoryPage> createState() => _AllStaffHistoryPageState();
}

class _AllStaffHistoryPageState extends State<AllStaffHistoryPage> {
